...
const Edit = () => {
    ...
    useEffect(() => {
        axios.get  (`https://banco-trequinhos.herokuapp.com/products/${id}`) /* (`http://localhost:8080/api/products/${id}`) */
        .then(response => {
            ...
            timer.current = window.setTimeout(() => {                
              setprogressLoading(false)
                ...
                if(hasError) {
                    ...
                    axios.put (`https://banco-trequinhos.herokuapp.com/products/${id}`,  /* (`http://localhost:8080/api/products/${id}`, */ 
                    {            
