...
const Products = () => {
    ...
    useEffect(() => {
        axios.get ('https://banco-trequinhos.herokuapp.com/products')/* ('http://localhost:8080/api/products') */
        .then(response => {
    ...
    const handleRemoveProduct = id => {
        axios.delete (`https://banco-trequinhos.herokuapp.com/products/${id}`)   /* (`http://localhost:8080/api/products/${id}`) */
         .then(response => {
